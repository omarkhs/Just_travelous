...
--
-- Host: localhost    Database: just travelous
-- ------------------------------------------------------
...
INSERT INTO `user2` VALUES ('ali@gmail.com','Ali','asdf'),('alice@gmail.com','Alice','alice'),('bob@gmail.com','Bob','bob'),('nerine@gmail','Nerine','12as'),('omar@gmail.com','Omar','1234');
...
INSERT INTO `user1` VALUES ('2','ali@gmail.com'),('5','alice@gmail.com'),('4','bob@gmail.com'),('1','nerine@gmail'),('3','omar@gmail.com');
...
INSERT INTO `adminuser` VALUES ('1'),('2'),('3');
...
INSERT INTO `generaluser` VALUES ('4'),('5');
...
INSERT INTO `country` VALUES ('Canada','North America'),('France','Europe'),('Italy','Europe'),('Japan','Asia'),('Spain','Europe'),('United States','North America');
...
INSERT INTO `city` VALUES ('Rome','00184'),('New York','10028'),('New York','10036'),('Minato','1050011'),('Shibuya','1510053'),('Madrid','28008'),('Madrid','28014'),('Pistoia','51100'),('Paris','75006'),('Paris','75007'),('Vancouver','V6A1X3'),('Whistler','V8E1B8');
...
CREATE TABLE `country_has_city` (
  ...
  PRIMARY KEY (`CountryNameCHC`,`CityNameCHC`,`PostalCodeCHC`),
  KEY `CityName_idx` (`CityNameCHC`,`PostalCodeCHC`),
  KEY `PostalCode_idx` (`PostalCodeCHC`) /*!80000 INVISIBLE */,
  CONSTRAINT `CityNameCHC` FOREIGN KEY (`CityNameCHC`) REFERENCES `city` (`CityName`),
  CONSTRAINT `CountryNameCHC` FOREIGN KEY (`CountryNameCHC`) REFERENCES `country` (`CountryName`),
  CONSTRAINT `PostalCodeCHC` FOREIGN KEY (`PostalCodeCHC`) REFERENCES `city` (`PostalCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `country_has_city` VALUES ('Spain','Madrid','28008'),('Spain','Madrid','28014'),('Japan','Minato','1050011'),('United States','New York','10028'),('United States','New York','10036'),('France','Paris','75006'),('France','Paris','75007'),('Italy','Pistoia','51100'),('Italy','Rome','00184'),('Japan','Shibuya','1510053'),('Canada','Vancouver','V6A1X3'),('Canada','Whistler','V8E1B8');
...
CREATE TABLE `experience` (
  ...
  `ExperienceName` char(30) DEFAULT NULL,
  `ExperienceRating` varchar(45) DEFAULT NULL,
  `ExperienceAccessibility` varchar(45) DEFAULT NULL,
  `ExperienceCost` varchar(45) DEFAULT NULL,
...
INSERT INTO `experience` VALUES ('1','Eiffel Tower','5','3','2'),('10','Cebo','4','4','4'),('11','Metropolitan Museum of Art','5','4','2'),('12','Shake Shack','3','3','1'),('2','Guy Savoy','4','5','5'),('3','Colosseum','5','4','2'),('4','Zoo of Pistoia','4','4','3'),('5','Tokyo Tower','3','4','3'),('6','Shin Udon','5','2','1'),('7','White Water Rafting','4','1','4'),('8','The Keefer Bar','4','4','3'),('9','Temple of Debod','4','2','1');
...
CREATE TABLE `restaurant` (
  `RestaurantExperienceId` char(15) NOT NULL,
...
INSERT INTO `restaurant` VALUES ('10',30,'Spanish'),('12',25,'Fast Food'),('2',50,'French');
...
CREATE TABLE `entertainment` (
  `EntertainExperienceId` char(15) NOT NULL,
...
INSERT INTO `entertainment` VALUES ('4',0),('7',5),('8',18);
...
CREATE TABLE `sightseeing` (
  `SightSeeExperienceId` char(15) NOT NULL,
...
INSERT INTO `sightseeing` VALUES ('1','yes'),('11','no'),('3','yes'),('5','no'),('9','yes');
...
INSERT INTO `address` VALUES ('5th Avenue',1000,'10028'),('8th Avenue',691,'10036'),('Avenue Anatole',5,'75007'),('Calle de Ferraz',1,'28008'),('Carrera de S. Jeronimo',34,'28014'),('Keefer St.',135,'V6A1X3'),('Mountain Square',4293,'V8E1B8'),('Piazza del Colosseo',1,'00184'),('Quai de Conti',11,'75006'),('Shibakoen',4,'1050011'),('Shibuya City',51,'1510053'),('Via Pieve a Celle',160,'51100');
...
CREATE TABLE `has_address` (
  `ExperienceIdHA` char(15) NOT NULL,
...
INSERT INTO `has_address` VALUES ('3','Piazza del Colosseo',1),('9','Calle de Ferraz',1),('5','Shibakoen',4),('1','Avenue Anatole',5),('2','Quai de Conti',11),('10','Carrera de S. Jeronimo',34),('6','Shibuya City',51),('8','Keefer St.',135),('4','Via Pieve a Celle',160),('12','8th Avenue',691),('11','5th Avenue',1000),('7','Mountain Square',4293);
...
INSERT INTO `city_has_experience` VALUES ('Rome','00184','3'),('New York','10028','11'),('New York','10036','12'),('Minato','1050011','5'),('Shibuya','1510053','6'),('Madrid','28008','9'),('Madrid','28014','10'),('Pistoia','51100','4'),('Paris','75006','2'),('Paris','75007','1'),('Vancouver','V6A1X3','8'),('Whistler','V8E1B8','7');
...
INSERT INTO `event` VALUES ('1','Honda Celebration of Lights','Fireworks Festival','20200725'),('2','Sakura Festival','Nature','20200315'),('3','Coachella','Music Festival','20201009'),('4','Cannes Film Festival','Film Festival','20200715');
...
INSERT INTO `organizer` VALUES ('1','Fireworks Festival Society'),('2','City of Nihonbashi'),('3','Anschutz Entertainment Group'),('4','French Association of Film');
